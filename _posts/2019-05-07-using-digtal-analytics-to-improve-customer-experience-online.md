...
<div class="usa-width-one-third usa-media_block">
  <ul style="list-style:none;padding-left:0px;">
    <li id="hisp"><a id="hisp-list" target="_blank" href="{{ site.baseurl }}/img/blog/DAP/dhs-cbp.png">Department of Homeland Security | U.S. Customs and Border Patrol</a></li>
...
<div class="usa-width-one-third usa-media_block">
  <ul style="list-style:none;padding-left:0px;">
    ...
    <li id="hisp"><a id="hisp-list" target="_blank" href="{{ site.baseurl }}/img/blog/DAP/hud-single-family-loans.png">Department of Housing and Urban Development | FHA Single Family Loans and Resources Center</a></li>
